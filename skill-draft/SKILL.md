...
- [ ] Completion gate — each of the 5 steps
- [ ] Escalation ladder — each of the 5 tiers, plus the "never skip" constraint
- [ ] Report file — treated as first-class artifact, updated now not later, committed alongside code
- [ ] Report file — CI rejection of regressions, exemption/baseline process
- [ ] Report file — git hash placement, minimal format fields
- [ ] Development nudge — don't batch tests, branch awareness
- [ ] Heroic: OS/platform mocking
- [ ] Heroic: error path simulation
- [ ] Heroic: elevated/interactive tests with instructional dialogs
- [ ] Heroic: browser/integration coverage
- [ ] Heroic: startup/shutdown testing
- [ ] Rationalization table — each row exercised by at least one scenario
- [ ] Red flags — each flag triggered by at least one scenario
- [ ] Dead code detection — agent considers deletion, not just exclusion
...
- Browser/integration coverage (no web-frontend scenario)
- Startup/shutdown testing (no daemon/init scenario)
- Meaningful-test-only red flag (no hollow-coverage scenario)
